...
AGunslingerCharacter::AGunslingerCharacter()
{
	...
	CreateDefaultSubobject<URuneAttributeSet>("Attributes");

	// Note: The skeletal mesh and anim blueprint references on the Mesh component (inherited from Character) 
	// are set in the derived blueprint asset named ThirdPersonCharacter (to avoid direct content references in C++)
}

UAbilitySystemComponent* AGunslingerCharacter::GetAbilitySystemComponent() const
{
...
//void AGunslingerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
//{
